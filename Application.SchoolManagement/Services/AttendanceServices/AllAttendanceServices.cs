...
namespace Application.SchoolManagement.Services.AttendanceServices
{
    public class AllAttendanceServices : IAllAttendanceOperation
    {
        private readonly IUnitOfRepository _unitOfWork;

        public AllAttendanceServices(IUnitOfRepository unitOfRepository)
        {
